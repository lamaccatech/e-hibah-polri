...
return [
    ...
    'dashboard' => [
        ...
        'polda-planning-heading' => 'Usulan',
        'polda-planning-created' => 'Usulan Dibuat',
        'polda-planning-unprocessed' => 'Usulan Belum Diproses',
        'polda-planning-processing' => 'Usulan Diproses',
        'polda-planning-rejected' => 'Usulan Ditolak',
        'polda-agreement-heading' => 'Perjanjian',
        'polda-agreement-created' => 'Perjanjian Dibuat',
        'polda-agreement-unprocessed' => 'Perjanjian Belum Diproses',
        'polda-agreement-processing' => 'Perjanjian Diproses',
        'polda-agreement-rejected' => 'Perjanjian Ditolak',
        'polda-inbox-heading' => 'Belum Diproses',
        'polda-inbox-column-name' => 'Nama Kegiatan',
        'polda-inbox-column-unit' => 'Satuan Kerja',
        'polda-inbox-column-stage' => 'Tahapan',
        'polda-inbox-column-status' => 'Status',
        'polda-inbox-column-action' => 'Aksi',
        'polda-inbox-empty' => 'Tidak ada hibah yang perlu diproses.',
        'mabes-title' => 'Dashboard Mabes',
        'mabes-description' => 'Statistik dan ringkasan hibah akan ditampilkan di sini.',
        'coming-soon' => 'Segera Hadir',
        'mabes-planning-heading' => 'Usulan',
        'mabes-planning-created' => 'Usulan Masuk',
        'mabes-planning-unprocessed' => 'Usulan Belum Diproses',
        'mabes-planning-processing' => 'Usulan Diproses',
        'mabes-planning-rejected' => 'Usulan Ditolak',
        'mabes-agreement-heading' => 'Perjanjian',
        'mabes-agreement-created' => 'Perjanjian Masuk',
        'mabes-agreement-unprocessed' => 'Perjanjian Belum Diproses',
        'mabes-agreement-processing' => 'Perjanjian Diproses',
        'mabes-agreement-rejected' => 'Perjanjian Ditolak',
        'mabes-realization-heading' => 'Realisasi',
        'mabes-realization-goods' => 'Hibah Barang / Jasa',
        'mabes-realization-money' => 'Hibah Uang',
        'mabes-realization-plan' => 'Rencana',
        'mabes-realization-actual' => 'Realisasi',
        'mabes-realization-percentage' => 'realisasi',
        'mabes-trend-heading' => 'Tren Tahunan',
    ],
